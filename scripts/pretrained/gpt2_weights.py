...
#copy pasted configs of pretrained model.
PRETRAINED_GPT2_CONFIGS = {
...
#update configs of original model with these
model_name = "gpt2-small (124M)"
NEW_CONFIG = cfg["XPERYV2_CONFIG"].copy()
NEW_CONFIG.update(PRETRAINED_GPT2_CONFIGS[model_name])
...
#set params, settings, and device
...
if __name__ == "__main__":
    token_ids = generate(
    model=gpt,
    idx=text_to_token_ids("What does it take to acheive those dreams, Antoine?", tokenizer).to(device),
    max_new_tokens=50,
